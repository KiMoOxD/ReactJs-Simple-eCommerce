import {
    ...
    DialogDescription,
    DialogContainer,
  } from './Other/DialogBase.tsx';
  import { PlusIcon } from 'lucide-react';
  import imgg from '../images/gucci.webp'
    ...
    return (
      ...
      >
        <DialogTrigger
          ...
          className='flex z-50 max-w-[270px] flex-col overflow-hidden border border-zinc-950/10 bg-white dark:border-zinc-50/10 dark:bg-zinc-900'
        >
          <DialogImage
            src={imgg}
