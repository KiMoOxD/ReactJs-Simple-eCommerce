...
export default function Menu() {
  ...
  return (
    <div className="lg:hidden text-xl cursor-pointer relative">
      ...
      {isMenuOpen && <div className="h-[98vh] w-[100vw] *:w-full *:text-center md:w-96 absolute top-[198%] right-[-75%] pt-14 flex flex-col gap-2 bg-[#0c0b1549] border border-stone-50/10 backdrop-blur-md shadow rounded-sm">
        <div className="text-white text-2xl absolute top-5 left-5" onClick={toggleMenu}>
          <IoMdExit />
        </div>
        <NavLink onClick={toggleMenu} to={'/'}><div className="hover:bg-[#ffffff2f] py-3 border border-stone-50/0 hover:border-stone-50/25 hover:backdrop-blur-lg shadow text-stone-50 hover:text-stone-200 transition">Home</div></NavLink>
        ...
        <div className="hover:bg-[#ffffff2f] py-3 border border-stone-50/0 hover:border-stone-50/25 hover:backdrop-blur-lg shadow text-stone-50 hover:text-stone-200 transition">Contacts</div>
      </div>}
      {isMenuOpen && (
